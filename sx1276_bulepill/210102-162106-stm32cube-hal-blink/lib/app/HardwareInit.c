...
/*------------------ SPI1 Configuration ends -------------------------------*/


/*------------------ SPI2 Configuration begins -------------------------------*/
  ...
  __HAL_RCC_SPI2_CLK_ENABLE();
    ...
    HAL_SPI_Init(&hspi2);
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_SET);  //SET SSLINE HIGH


/*------------------ SPI2 Configuration ends -------------------------------*/
