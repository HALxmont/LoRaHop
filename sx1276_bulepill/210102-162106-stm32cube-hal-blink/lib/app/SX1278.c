...
int SX1278_LoRaEntryRx(SX1278_t *module, uint8_t length, uint32_t timeout) {
	...
	SX1278_SPIWrite(module, LR_RegHopPeriod, 0xFF);	//yes FHSS //was FF
...
int SX1278_LoRaEntryTx(SX1278_t *module, uint8_t length, uint32_t timeout) {
	...
	SX1278_SPIWrite(module, LR_RegHopPeriod, 0x00); //RegHopPeriod yes FHSS //01
...
uint8_t SX1278_LastSNR(SX1278_t *module){
	uint8_t snr;
	snr = SX1278_SPIRead(module, LR_RegPktSnrValue);
	return snr;
}

uint8_t SX1278_LastRSSI(SX1278_t *module){
	uint8_t rssi;
	rssi = SX1278_SPIRead(module, LR_RegPktRssiValue);
	return rssi;
}